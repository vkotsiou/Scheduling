...
class Mote(object):
    ...
    def __init__(self, id, eui64=None):
        ...
        self.R                         = 7     # maximum network's hops -predefined
    ...
    def setDagRoot(self):
        ...
        #:) Set DagRoot hops to 0
        self.hops = 0
        self.max_hops = -1

        #Calculate Schedule matrix limits
        self.sf.Cmin, self.sf.Cmax = self.sf.limits()
        print "&ID", self.id, "Limits", "\n", self.sf.Cmin, self.sf.Cmax
    # ==== address
