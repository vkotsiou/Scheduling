...
# ===== Low Delay Scheduling Function LD_SF  :)
SubFrameSize                                = 5                   # 2*5
#CBR                                         = 30#settings.tsch_tx_queue_size #30                 # in seconds
#SlotFrameSize                               = 101
#VirtualSlotFrameSize                        =   CBR*SlotFrameSize #in slots
