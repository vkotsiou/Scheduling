...
# :) mylogs schedule stats
LOG_TSCH_ALLOC_CELLS                   = {'type': 'tsch.alloc_cells',             'keys': ['_mote_id','slotframe_no','shared', 'tx', 'rx']}
LOG_TSCH_USED_CELLS                   = {'type': 'tsch.used_cells',               'keys': ['_mote_id','asn','type','cell_type']}   # :) type tx,rx
LOG_TSCH_VALLOC_CELLS                   = {'type': 'tsch.valloc_cells',           'keys': ['_mote_id','main_TX','ghost_TX','main_RX','ghost_RX','keep_alive_TX','keep_alive_RX']}
